...
import type { Bid as _Bid, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async acceptContract(arg0: string): Promise<{
        __kind__: "ok";
        ok: string;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.acceptContract(arg0);
    ...
    async adminGetAllBidders(arg0: string): Promise<{
        __kind__: "ok";
        ok: Array<UserProfile>;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.adminGetAllBidders(arg0);
    ...
    async adminGetAllBids(arg0: string): Promise<{
        __kind__: "ok";
        ok: Array<Bid>;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.adminGetAllBids(arg0);
    ...
    async adminLockBidding(arg0: string, arg1: boolean): Promise<{
        __kind__: "ok";
        ok: string;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.adminLockBidding(arg0, arg1);
                return from_candid_variant_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminSelectWinner(arg0: string, arg1: string): Promise<{
        __kind__: "ok";
        ok: string;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.adminSelectWinner(arg0, arg1);
                return from_candid_variant_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMyBid(arg0: string): Promise<{
        __kind__: "ok";
        ok: Bid;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.getMyBid(arg0);
    ...
    async register(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: string, arg6: string, arg7: string, arg8: string, arg9: string, arg10: string): Promise<{
        __kind__: "ok";
        ok: string;
    } | {
        __kind__: "err";
        ...
        if (this.processError) {
            try {
                const result = await this.actor.register(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
                return from_candid_variant_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
